...
class User(SQLModel, table=True):
    ...
    experiences: Optional[List["Experience"]] = Relationship(back_populates="owner", sa_relationship_kwargs={"cascade": "all,delete,delete-orphan"})
    educations: Optional[List["Education"]] = Relationship(back_populates="owner", sa_relationship_kwargs={"cascade": "all,delete,delete-orphan"})
    profile_photo: Optional["ProfilePhoto"] = Relationship(back_populates="owner", sa_relationship_kwargs={"cascade": "all,delete,delete-orphan"})

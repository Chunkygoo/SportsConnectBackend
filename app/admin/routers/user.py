...
def get_users(request: Request, response: Response, id: str = "-1", limit: int = 10, offset: int = 0, order:str="id.asc", q:str="", 
    ...
    order_direction_map = {
        ...
        "contact_number": [models.User.contact_number, models.User.contact_number.desc()],
        "current_address": [models.User.current_address, models.User.current_address.desc()],
    ...
    if q != "":
        statement = statement.where(or_(models.User.username.contains(q), 
